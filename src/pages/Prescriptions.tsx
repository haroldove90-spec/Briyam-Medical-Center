...
export function Prescriptions() {
  ...
  const handlePrint = (prescription: Prescription) => {
    ...
    // Header
    doc.setFontSize(22);
    doc.setTextColor(3, 36, 90); // #03245A
    doc.setFont('helvetica', 'bold');
    doc.text('Dr. Christian Janis Sandoval', margin, yPos);
    yPos += 25;
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <button type="button" onClick={handleAddMedication} className="text-sm text-[#03245A] hover:text-[#1691CC] font-medium">
                ...
                <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                  <div className="md:col-span-1">
                    <input
                      ...
                      required
                      className="block w-full border border-slate-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#03245A] focus:border-[#03245A] sm:text-sm"
                      value={med.name}
        ...
        <>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {filteredPrescriptions.map((prescription) => (
              <div key={prescription.id} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:border-[#03245A]/50 transition-colors">
                <div className="p-5 border-b border-slate-100 bg-slate-50/50">
                  <div className="flex justify-between items-start">
                    <div className="flex items-center space-x-3">
                      <div className="bg-[#03245A]/10 p-2 rounded-full text-[#03245A]">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 pt-4 border-t border-slate-100 flex justify-end">
                    <button 
                      ...
                      className="inline-flex items-center text-sm text-[#03245A] hover:text-[#1691CC] font-medium"
                    >
