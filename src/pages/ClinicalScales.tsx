    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="text-right">
          ...
          <div className="text-3xl font-bold text-[#03245A]">{totalScore}</div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
        ...
        <select
          className="block w-full rounded-md border-slate-300 shadow-sm focus:border-[#03245A] focus:ring-[#03245A] sm:text-sm p-2 border"
              ...
              {q.options.map((opt) => (
                <button
                  ...
                  className={`text-left px-4 py-2 rounded-md text-sm transition-colors ${
                    scores[q.id] === opt.val
                      ? 'bg-blue-100 text-[#03245A] border border-blue-200 font-medium'
      ...
      <div className="sticky bottom-6 flex justify-end">
        <button
          ...
          className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-full shadow-lg text-white bg-[#03245A] hover:bg-[#1691CC] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#03245A] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
