...
export function Reports() {
  ...
  const exportPatientsPDF = () => {
    ...
    autoTable(doc, {
      ...
      headStyles: { fillColor: [3, 36, 90] }, // #03245A
    });
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#03245A] mt-1">${dailyIncome}</p>
            </div>
            <div className="p-3 bg-blue-50 rounded-full">
              <DollarSign className="h-6 w-6 text-[#03245A]" />
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#03245A] mt-1">${weeklyIncome}</p>
            </div>
            <div className="p-3 bg-blue-50 rounded-full">
              <DollarSign className="h-6 w-6 text-[#03245A]" />
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#03245A] mt-1">${monthlyIncome}</p>
            </div>
            <div className="p-3 bg-blue-50 rounded-full">
              <DollarSign className="h-6 w-6 text-[#03245A]" />
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center bg-slate-50">
          <h3 className="text-lg font-medium text-slate-900 flex items-center">
            <DollarSign className="h-5 w-5 mr-2 text-[#03245A]" />
            Registro de Ingresos
          </h3>
          <button 
            onClick={exportIncomePDF}
            className="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md text-white bg-[#03245A] hover:bg-[#1691CC]"
          >
            ...
            <tbody className="bg-white divide-y divide-slate-200">
              {incomeRecords.map((record) => (
                <tr key={record.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#03245A]">
                    ${record.amount}
                  </td>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center bg-slate-50">
          <h3 className="text-lg font-medium text-slate-900 flex items-center">
            <Users className="h-5 w-5 mr-2 text-[#03245A]" />
