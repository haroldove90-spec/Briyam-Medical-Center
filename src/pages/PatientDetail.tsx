...
export function PatientDetail() {
  ...
  const exportToPDF = () => {
    ...
    doc.text('Historial Médico - Dr. Christian Janis Sandoval', margin, yPos);
    yPos += 30;
          ...
          <div className="flex flex-wrap gap-2 w-full md:w-auto">
            ...
            {isEditing ? (
              <>
                ...
                <button 
                  onClick={handleSave}
                  className="inline-flex items-center justify-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-white bg-[#03245A] hover:bg-[#1691CC] focus:outline-none flex-1 md:flex-none"
                >
              ...
              <button 
                ...
                className={cn(
                  ...
                  (!patient.history.chiefComplaint && !patient.history.assessment)
                    ? "border-transparent text-white bg-[#03245A] hover:bg-[#1691CC]"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white shadow-sm rounded-xl p-6 border border-slate-200">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold text-slate-900 flex items-center">
                    <Activity className="w-5 h-5 mr-2 text-[#03245A]" />
                    Estado Actual
                  </h3>
                </div>
                   ...
                   <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                       ...
                       <div className="bg-white border border-slate-200 rounded p-2 flex flex-col justify-center items-center">
                         ...
                         <p className="text-xl font-bold text-[#03245A]">
                           {isEditing 
          ...
          {activeTab === 'medications' && (
            <div className="bg-white shadow-sm rounded-xl p-6 border border-slate-200">
              <h3 className="text-lg font-semibold text-slate-900 mb-4 flex items-center">
                <Pill className="w-5 h-5 mr-2 text-[#03245A]" />
                Medicación Activa
              </h3>
          ...
          <div className="bg-white shadow-sm rounded-xl p-6 border border-slate-200">
            ...
            {patient.nextAppointment ? (
              <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
                <Calendar className="w-5 h-5 text-[#03245A] mt-0.5" />
                <div>
                  <p className="text-sm font-medium text-blue-900">Visita de Seguimiento</p>
                  <p className="text-xs text-blue-700">{format(new Date(patient.nextAppointment), 'd MMM, yyyy - h:mm a', { locale: es })}</p>
                </div>
              </div>
            ) : (
