    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6">
        ...
        <div className="space-y-2">
          ...
          <textarea
            className="w-full h-32 p-4 rounded-lg border border-slate-300 focus:ring-2 focus:ring-[#03245A] focus:border-transparent resize-none font-mono text-sm"
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#03245A] hover:bg-[#1691CC] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#03245A] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isProcessing ? (
              <>
      ...
      {structuredData && (
        <div className="bg-slate-50 shadow-sm border border-slate-200 rounded-xl p-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <h3 className="text-lg font-semibold text-slate-900 mb-4 flex items-center">
            <FileJson className="h-5 w-5 mr-2 text-[#03245A]" />
          ...
          <div className="mt-4 flex justify-end items-center space-x-4">
             <select
               className="block rounded-md border-slate-300 shadow-sm focus:border-[#03245A] focus:ring-[#03245A] sm:text-sm p-2 border"
             ...
             <button
              className="inline-flex items-center px-4 py-2 border border-slate-300 shadow-sm text-sm font-medium rounded-md text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#03245A] disabled:opacity-50"
