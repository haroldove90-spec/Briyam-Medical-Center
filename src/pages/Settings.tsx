      ...
      <div className="bg-white shadow-sm border border-slate-200 rounded-xl overflow-hidden">
        ...
        <div className="p-6 border-b border-slate-200 bg-slate-50/30">
          <h2 className="text-lg font-medium text-slate-900 flex items-center mb-4">
            <Database className="h-5 w-5 mr-2 text-[#03245A]" />
          ...
          <div className="mt-4 flex justify-end space-x-3">
            <button
              ...
              className="inline-flex items-center px-3 py-1.5 border border-slate-300 shadow-sm text-xs font-medium rounded-md text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#03245A]"
            >
        ...
        <div className="p-6 border-b border-slate-200">
          <h2 className="text-lg font-medium text-slate-900 flex items-center">
            <User className="h-5 w-5 mr-2 text-[#03245A]" />
            Perfil del Médico
          </h2>
          <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
            <div>
              <label htmlFor="first-name" className="block text-sm font-medium text-slate-700">Nombre</label>
              <input type="text" name="first-name" id="first-name" defaultValue="Christian Janis" className="mt-1 block w-full border border-slate-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#03245A] focus:border-[#03245A] sm:text-sm" />
            </div>
            <div>
              <label htmlFor="last-name" className="block text-sm font-medium text-slate-700">Apellido</label>
              <input type="text" name="last-name" id="last-name" defaultValue="Sandoval" className="mt-1 block w-full border border-slate-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#03245A] focus:border-[#03245A] sm:text-sm" />
            </div>
            <div className="sm:col-span-2">
              <label htmlFor="specialty" className="block text-sm font-medium text-slate-700">Especialidad</label>
              <input type="text" name="specialty" id="specialty" defaultValue="Neurología Clínica" className="mt-1 block w-full border border-slate-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#03245A] focus:border-[#03245A] sm:text-sm" />
            </div>
          </div>
        </div>
        ...
        <div className="p-6 border-b border-slate-200 bg-slate-50/50">
          <h2 className="text-lg font-medium text-slate-900 flex items-center mb-4">
            <Clock className="h-5 w-5 mr-2 text-[#1691CC]" />
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#03245A] ${reminderEnabled ? 'bg-[#03245A]' : 'bg-slate-200'}`}
              >
              ...
              <div className="ml-8 p-4 bg-white border border-slate-200 rounded-lg animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <input
                    ...
                    className="w-20 rounded-md border-slate-300 shadow-sm focus:border-[#03245A] focus:ring-[#03245A] sm:text-sm p-2 border"
                  />
                  <select
                    value={reminderTimeUnit}
                    onChange={(e) => setReminderTimeUnit(e.target.value)}
                    className="rounded-md border-slate-300 shadow-sm focus:border-[#03245A] focus:ring-[#03245A] sm:text-sm p-2 border"
                  >
        ...
        <div className="p-6 border-b border-slate-200">
          <h2 className="text-lg font-medium text-slate-900 flex items-center mb-4">
            <Globe className="h-5 w-5 mr-2 text-[#1691CC]" />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#03245A] ${notifications ? 'bg-[#03245A]' : 'bg-slate-200'}`}
              >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#03245A] ${darkMode ? 'bg-[#03245A]' : 'bg-slate-200'}`}
              >
