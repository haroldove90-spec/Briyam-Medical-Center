    ...
    <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-10">
      <div className="flex items-center flex-1">
        ...
        <div className="relative w-full max-w-md hidden sm:block" ref={searchRef}>
          ...
          <input
            type="text"
            className="block w-full pl-10 pr-3 py-2 border border-slate-300 rounded-md leading-5 bg-slate-50 placeholder-slate-500 focus:outline-none focus:placeholder-slate-400 focus:ring-1 focus:ring-[#03245A] focus:border-[#03245A] sm:text-sm transition duration-150 ease-in-out"
      ...
      <div className="flex items-center space-x-4">
        {role === 'assistant' && (
          <span className="hidden md:inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#03245A]/10 text-[#03245A]">
            Modo Asistente
          </span>
        )}
