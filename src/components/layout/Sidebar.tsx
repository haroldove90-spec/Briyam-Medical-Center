...
export function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  return (
    <div className={cn(
      "fixed inset-y-0 left-0 z-30 w-64 transform bg-[#03245A] text-white transition-transform duration-300 ease-in-out lg:static lg:translate-x-0",
      ...
      <div className="flex h-16 items-center justify-between px-6 border-b border-white/10">
        <div className="flex items-center">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold tracking-tight leading-tight">Dr. Christian Janis Sandoval</span>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive
                  ? 'bg-white/10 text-white border-l-4 border-[#1691CC]'
        ...
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <p className="text-sm font-medium text-white">
              {role === 'doctor' ? 'Dr. Christian Janis' : 'Asistente'}
            </p>
