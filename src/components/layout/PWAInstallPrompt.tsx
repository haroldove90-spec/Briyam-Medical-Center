        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-5 flex flex-col gap-4">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="bg-[#03245A]/10 p-3 rounded-xl">
                <Smartphone className="h-6 w-6 text-[#03245A]" />
              </div>
              <div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-[#03245A] text-white py-2.5 px-4 rounded-xl font-medium text-sm hover:bg-[#1691CC] transition-colors flex items-center justify-center gap-2"
            >
